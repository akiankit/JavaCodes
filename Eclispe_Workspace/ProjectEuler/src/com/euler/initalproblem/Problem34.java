...
public class Problem34 {
	...
	// If n is a natural number of d digits that is a factorion, then 10^d − 1 ≤ n ≤ 9!d and this fails to hold for d ≥ 8.
	// Thus n has 7 digits and the maximum sum of factorials of digits for a 7 digit number is 9!7 = 2,540,160, which is the upper bound.
