...
public class SecureHTTPConnection {
    ...
    private static final Logger log = LoggerFactory.getLogger(SecureHTTPConnection.class);
    ...
    public void init() {
        if (applicationContext instanceof ConfigurableApplicationContext) {
            log.info("SecureHTTPConnection.init(): Registering the shutdown hook********");
    ...
    public String executeGetRequest(String serviceUrl, String path, Map<String, Object> queryParams) throws Exception {
        log.debug("SecureHTTPConnection.executeGetRequest(): GET ServiceUrl={}/{}", serviceUrl, path);
        ...
        try {
            ...
            log.error("Error executing GET https://" + serviceUrl + "/" + path + " : Reason = " + exception.toString(), exception);
            httpGet.abort();
            throw exception;
        }
    }
    ...
    public String executePostRequest(String serviceUrl, String path, Map<String, Object> formParams) throws Exception {
        log.debug("SecureHTTPConnection.executePostRequest(): Post ServiceUrl={}/{}", serviceUrl, path);
        ...
        try {
            ...
            log.error("Error executing POST https://" + serviceUrl + "/" + path + ": Reason= " + exception.toString(), exception);
            httpPost.abort();
            throw exception;
        }
    }
