...
public class ArraysUtil {
	...
	public static void print1DArray(Object[] array, String seperator) {
	...
	public static void getValidSubsetsForASum(int sum, int[] nums, int index, List<Integer> currSolution,
	...
	public static void getLengthNSubsetsWithSumK(int k, int length, int[] nums, int index, List<Integer> currSolution,
	                Set<List<Integer>> solutionSets) {
		Set<List<Integer>> solutionSets1 = new HashSet<>();
