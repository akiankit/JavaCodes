...
import com.structures.ds.SumSegmentTreeSelfWritten.SegmentTreeNode;
...
//        MinSegmentTreeSelfWritten segmentTree = new MinSegmentTreeSelfWritten();
//        int[] arr = {1,2,7,8,5};
    }
    ...
    public ArrayList<Integer> intervalMinNumber(int[] A, 
        ...
        if(A == null || queries == null)
            return list;
        SegmentTreeNode root = minTree.createSegmentTree(A);
...
class MinSegmentTreeSelfWritten{
